...
const labels: Record<string, string> = {
  ...
  REASSIGNED: "Pridelená inému používateľovi",
  UPDATED: "Upravená",
...
const settingLabels: Record<string, string> = {
  ...
  "sales.daily_visit_target": "Denný cieľ návštev",
  "sales.default_visit_duration_minutes": "Trvanie návštevy (minúty)",
  "sales.workday_minutes": "Dĺžka pracovného dňa (minúty)",
  "sales.route_average_speed_kmh": "Priemerná rýchlosť trasy (km/h)",
  "sales.route_distance_penalty_per_km": "Geografická penalizácia na kilometer",
  "sales.opportunity_expiry_days": "Platnosť príležitosti (dni)",
  "sales.opportunity_visit_overdue_days": "Návšteva po termíne (dni)",
  "sales.opportunity_high_commercial_value": "Referenčný vysoký obchodný potenciál",
  "sales.opportunity_weight_commercial": "Váha: obchodný potenciál",
  "sales.opportunity_weight_reorder": "Váha: opakovaná objednávka",
  "sales.opportunity_weight_reactivation": "Váha: reaktivácia",
  "sales.opportunity_weight_decline": "Váha: pokles obratu",
  "sales.opportunity_weight_cross_sell": "Váha: doplnkový predaj",
  "sales.opportunity_weight_visit_overdue": "Váha: návšteva po termíne",
  "sales.opportunity_weight_task_campaign": "Váha: úloha alebo kampaň",
  "sales.opportunity_weight_strategic": "Váha: strategická priorita",
  "sales.route_default_start_latitude": "Východisková zemepisná šírka",
  "sales.route_default_start_longitude": "Východisková zemepisná dĺžka",
  "sales.route_default_end_latitude": "Cieľová zemepisná šírka",
  "sales.route_default_end_longitude": "Cieľová zemepisná dĺžka",
...
const settingDescriptions: Record<string, string> = {
  ...
  "sales.daily_visit_target": "Odporúčaný počet obchodných návštev za deň.",
  "sales.default_visit_duration_minutes": "Čas rezervovaný na jednu návštevu.",
  "sales.workday_minutes": "Maximálne trvanie plánovanej pracovnej trasy.",
  "sales.route_average_speed_kmh": "Orientačná rýchlosť bez živých dopravných údajov.",
  "sales.route_distance_penalty_per_km": "Vplyv vzdialenosti na poradie zastávok.",
  "sales.opportunity_expiry_days": "Počet dní, počas ktorých zostáva odporúčanie aktuálne.",
  "sales.opportunity_visit_overdue_days": "Interval bez návštevy považovaný za oneskorený.",
  "sales.opportunity_high_commercial_value": "Hodnota na normalizáciu obchodného potenciálu.",
  "sales.route_default_start_latitude": "Východiskový bod trasy; v produkcii musí byť nastavený.",
  "sales.route_default_start_longitude": "Východiskový bod trasy; v produkcii musí byť nastavený.",
  "sales.route_default_end_latitude": "Koncový bod trasy; v produkcii musí byť nastavený.",
  "sales.route_default_end_longitude": "Koncový bod trasy; v produkcii musí byť nastavený.",
...
const apiErrors: Record<string, string> = {
  ...
  TASK_STATE_INVALID: "Túto akciu už nemožno pre aktuálny stav úlohy vykonať.",
  ...
  OPPORTUNITY_NOT_FOUND: "Obchodná príležitosť sa nenašla.",
  OPPORTUNITY_STATE_INVALID: "Stav obchodnej príležitosti neumožňuje túto akciu.",
  ROUTE_NOT_FOUND: "Denná trasa sa nenašla.",
  ROUTE_STOP_NOT_FOUND: "Zastávka trasy sa nenašla.",
  ROUTE_STATE_INVALID: "Stav trasy neumožňuje túto akciu.",
  ROUTE_ORIGIN_REQUIRED: "Pred plánovaním nastavte východiskový a cieľový bod trasy.",
