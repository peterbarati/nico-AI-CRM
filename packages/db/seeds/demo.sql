...
INSERT OR IGNORE INTO tasks (id, customer_id, customer_location_id, assigned_user_id, created_by_user_id, source_interaction_id, title, description, task_type, priority, status, due_at, completed_at, created_at, updated_at) VALUES
  ...
  ('tsk-002', 'cus-003', 'loc-003-main', 'usr-sales-002', 'usr-cs-002', 'int-002', 'Visit Cedar Office', 'Customer Service handoff due to declining order value.', 'handoff', 'high', 'open', '2026-09-15T10:00:00.000Z', NULL, '2026-09-07T11:10:00.000Z', '2026-09-07T11:10:00.000Z'),
  ('tsk-003', 'cus-007', 'loc-007-main', 'usr-cs-003', 'usr-cs-003', 'int-003', 'Check B2B registration', NULL, 'follow_up', 'normal', 'open', '2026-09-14T08:00:00.000Z', NULL, '2026-09-06T08:10:00.000Z', '2026-09-06T08:10:00.000Z'),
  ('tsk-004', 'cus-009', 'loc-009-main', 'usr-cs-001', 'usr-cs-001', 'int-004', 'Send campaign offer', 'Clicked campaign without purchase.', 'email', 'high', 'in_progress', '2026-09-11T13:00:00.000Z', NULL, '2026-09-05T13:10:00.000Z', '2026-09-05T13:10:00.000Z'),
